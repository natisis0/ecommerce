      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-500 leading-relaxed max-w-sm">
              Providing modern essentials for the conscious consumer. Designed
              for longevity, crafted with care.
            </p>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
              <button
                type="submit"
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} NextGen Store Inc. All rights
            reserved.
          </p>
